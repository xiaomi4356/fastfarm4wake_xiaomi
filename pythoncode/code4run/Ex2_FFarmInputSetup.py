...
if __name__ == '__main__':
    ...
    templateFSTF = 'fastfarm\offshoreWTs_zxj\FAST.Farm_mode.fstf'    # template file used for FastFarm input file, need to exist
    outputFSTF   = 'fastfarm\offshoreWTs_zxj\FAST.Farm_mode.fstf'# new file that will be written
    ...
    BTSFilename    = 'fastfarm\TSinflow\90m_08mps_mod1.bts' # TurbSim Box to be used in FAST.Farm simulation, need to exist.
    # --- Layout
    xWT = [0.0]  # x positions of turbines
    yWT = [0.0]  # y postitions of turbines
    zWT = [0.0]   # z postitions of turbines
